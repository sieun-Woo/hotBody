...
public enum ExceptionStatus {
  ...
  USERNAME_DO_NOT_MATCH(401,"아이디와 비빌번호를 확인바랍니다."),
  PASSWORDS_DO_NOT_MATCH(401,"아이디와 비빌번호를 확인바랍니다."),
  ...
  POST_IS_NOT_EXIST(404, "상품이 존재하지 않습니다."),
  COMMENT_IS_NOT_EXIST(404, "상품이 존재하지 않습니다."),
